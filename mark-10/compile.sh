...
gcc ./net/logs-collector.c ./net/client-tools.c ./util/parser.c -O2 -lrt -lm -o logs-collector
gcc ./net/manager.c ./net/client-tools.c ./util/parser.c -O2 -lrt -lm -o manager
